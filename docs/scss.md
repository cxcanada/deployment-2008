...
## Pre Flight
1. Compiler scss ==> css
2. LiveSass Compiler for VS Code extension, or use sass on command line if you choose to.
3. Configure the extension settings ==> user.setting.json
```json
...
```
4. Complie sass, turn on the LiveSass watch
```cmd
CTRL+Shift+P
LiveSass: Watch Sass
```
